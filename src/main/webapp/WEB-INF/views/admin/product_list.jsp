...
<div class="admin_content">
	...
	<div class="admin_product_list">
		<div class="admin_product_info df">
			...
			<div class="admin_product_delete jcce aice">삭제</div>
		</div>
		<div class="admin_product_item_box">
			<c:forEach var="dto" items="${list }">
				<div class="admin_product_item df">
					...
					<div class="admin_product_price jcce aice">${dto.product_price }원</div>
					<div class="admin_product_sale jcce aice">${dto.product_sale }%</div>
					...
					<div class="admin_product_delete jcce aice">
						<button class="admin_product_delete_button" value="${dto.product_name }">삭제</button>
					</div>
				</div>
			</c:forEach>
		</div>
