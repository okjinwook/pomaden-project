...
<main>
	<div class="myPage_component">
		...
		<div class="myPage_kinds_box aice jcsb">
			<div class="myPage_kind jcce aice">주문내역</div>
			<div class="myPage_kind jcce aice">포인트</div>
			<div class="myPage_kind jcce aice">쿠폰</div>
			<div class="myPage_kind jcce aice">게시글</div>
			<div class="myPage_kind jcce aice">좋아요 상품</div>
			<div class="myPage_kind jcce aice">회원정보 관리</div>
			<div class="myPage_kind jcce aice">문의내역</div>
		</div>
		...
		<div class="myPage_orderList_box">
			...
			<div class="myPage_orderList_content df">
